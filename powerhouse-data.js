...
// super stat class
/**@constructor*/
SuperStat = function(id, name, desc, tip) {
    this.id = id;
    this.name = name;
    this.desc = desc;
    this.tip = tip;
...
// super stat data
var dataSuperStat = new Array();
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, null, null, null);
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, 'Super Strength', '<img src="img/SuperStat_Strength.png" />&nbsp;Super Strength', 'Improves Knock Back, Knock Back Resistance, breaking from Tangible Holds, the pick-up and throw ability, and melee damage.');
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, 'Super Dexterity', '<img src="img/SuperStat_Dexterity.png" />&nbsp;Super Dexterity', 'Improves a hero\\\'s Critical Hit Chance and effectiveness of Stealth granting powers.');
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, 'Super Constitution', '<img src="img/SuperStat_Constitution.png" />&nbsp;Super Constitution', 'Improves a hero\\\'s Hit Points.');
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, 'Super Intelligence', '<img src="img/SuperStat_Intelligence.png" />&nbsp;Super Intelligence', 'Affects the hero\\\'s power cooldown length, Stealth Detection, and the energy cost of their powers.');
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, 'Super Ego', '<img src="img/SuperStat_Ego.png" />&nbsp;Super Ego', 'Improves Critical Hit Severtiy and breaking from Intangible Holds.');
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, 'Super Presence', '<img src="img/SuperStat_Recovery.png" />&nbsp;Super Presence', 'Affects the amount a hero heals and the amount of threat they generate (depending on the current role they are using).');
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, 'Super Recovery', '<img src="img/SuperStat_Recovery.png" />&nbsp;Super Recovery', 'Sets the hero\\\'s Equilibrium and increases rate of energy generated from energy building attacks.');
dataSuperStat[dataSuperStat.length] = new SuperStat(dataSuperStat.length, 'Super Endurance', '<img src="img/SuperStat_Endurance.png" />&nbsp;Super Endurance', 'Affects a hero\\\'s maximum energy and rate of energy generated from fighting attacks.');
...
// innate talent data
var dataInnateTalent = new Array();
...
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Inferno', 'The Inferno', 'End: 10, Dex: 8, Ego: 8, Rec: 10', 'This is the innate talent for The Inferno.<br />Con: 5, End: 10, Str: 5, Dex: 8, Int: 5, Ego: 8, Pre: 5, Rec: 10');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Soldier', 'The Soldier', 'End: 8, Dex: 10, Int: 8, Ego: 10', 'This is the innate talent for The Soldier.<br />Con: 5, End: 8, Str: 5, Dex: 10, Int: 8, Ego: 10, Pre: 5, Rec: 5');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Blade', 'The Blade', 'End: 8, Str: 10, Dex: 10, Ego: 8', 'This is the innate talent for The Blade.<br />Con: 5, End: 8, Str: 10, Dex: 10, Int: 5, Ego: 8, Pre: 5, Rec: 5');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Savage', 'The Savage', 'Con: 10, End: 8, Str: 10, Dex: 8', 'This is the innate talent for The Brute.<br />Con: 10, End: 8, Str: 10, Dex: 8, Int: 5, Ego: 5, Pre: 5, Rec: 5');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Behemoth', 'The Behemoth', 'Con: 10, End: 8, Str: 10, Pre: 8', 'This is the innate talent for The Behemoth.<br />Con: 10, End: 8, Str: 10, Dex: 5, Int: 5, Ego: 5, Pre: 8, Rec: 5');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Glacier', 'The Glacier', 'Con: 8, End: 10, Dex: 10, Rec: 8', 'This is the innate talent for The Glacier.<br />Con: 8, End: 10, Str: 5, Dex: 10, Int: 5, Ego: 5, Pre: 5, Rec: 8');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Mind', 'The Mind', 'End: 10, Int: 8, Pre: 10, Rec: 8', 'This is the innate talent for The Mind.<br />Con: 5, End: 10, Str: 5, Dex: 5, Int: 8, Ego: 5, Pre: 10, Rec: 8');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Grimoire', 'The Grimoire', 'End: 8, Int: 10, Pre: 10, Rec: 8', 'This is the innate talent for The Grimoire.<br />Con: 5, End: 8, Str: 5, Dex: 5, Int: 10, Ego: 5, Pre: 10, Rec: 8');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Specialist', 'The Specialist', 'End: 8, Str: 8, Dex: 10, Int: 10', 'This is the innate talent for The Assassin.<br />Con: 5, End: 8, Str: 8, Dex: 10, Int: 10, Ego: 5, Pre: 5, Rec: 5');
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Marksman', 'The Marksman', 'End: 8, Dex: 10, Int: 10, Ego: 8', 'This is the innate talent for The Marksman.<br />Con: 5, End: 8, Str: 5, Dex: 10, Int: 10, Ego: 8, Pre: 5, Rec: 5');
...
dataTalent[dataTalent.length] = new Talent(dataTalent.length, 'Impressive Physicque', 'Impressive Physicque', 'Str: 5, Pre: 5');
...
TravelPower = function(id, name, desc, tip) {
    ...
    this.getAdvantage = function(mask) {
        ...
        if (mask > 0) {
            for (var i=1; i<this.advantage.length; i++) {
                var test = Math.pow(2, i);
                if ((mask & test) == test) {
                    advantage.push(this.advantage[i]);
                }
            }
        }
        return advantage;
    ...
    this.getPoints = function(mask) {
        ...
        if (mask > 0) {
            for (var i=1; i<this.advantage.length; i++) {
                var test = Math.pow(2, i);
                if ((mask & test) == test) {
                    points += this.advantage[i].points;
                }
            }
        }
        return points;
    ...
    this.toString = function() {
        advantage = '[';
        for (var i=1; i<this.advantage.length; i++) {
            if (i > 1) advantage = advantage+',';
            advantage = advantage+'<br /> &nbsp;&nbsp;&nbsp;&nbsp; '+this.advantage[i].toString();
        }
        advantage = advantage+'<br />]';
        return '[id='+this.id+', name=\''+this.name+'\', desc=\''+this.desc+'\', tip=\''+this.tip+'\', advantage='+advantage+', code='+this.code()+']';
    }
}

// travel power data
var dataTravelPower = new Array();
...
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(1, 'Rank 2', 'Rank 2', 1, null, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 1, 1, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(3, 'Rebounding Resilience', 'Rebounding Resilience', 2, null, 'While Superjump is active, holds are more difficult to land on you.'));

dataTravelPower[dataTravelPower.length] = new TravelPower(dataTravelPower.length, 'Superspeed', '<img src="img/TravelPower_Superspeed.png" />&nbsp;Superspeed', 'Faster than a speeding bullet isn\\\'t just a metaphor in your case.<br /><br />Tap<br />+ Greatly increases your run speed.<br />+ While out of combat, your run speed will increase over several stages.<br />- While in combat, your run speed is reduced, but sill greater than the default run speed.<br />- While active, energy cost of all powers is increased and your energy generation is reduced.<br /><br />Charge<br />+ When fully charged, superspeed activates at maximum speed.');
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(1, 'Rank 2', 'Rank 2', 1, null, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 1, 1, null));
...
dataTravelPower[dataTravelPower.length] = new TravelPower(dataTravelPower.length, 'Acrobatics', '<img src="img/TravelPower_Acrobatics.png" />&nbsp;Acrobatics', 'Your natural physical gifts allow you to move in ways and at speeds most people wouldn\\\'t dream of.<br /><br />Tap<br />+ Increases run speed, jump height, and the speed you move while jumping.<br />+ While out of combat, your run speed, jump height, and jump speed will increase over several stages.<br />- The run speed, jump height, and jump speed granted are not as large as the run speed granted by Superspeed or the jump height and jump speed granted by Superjump.<br />- While in combat, your run speed, jump height, and jump speed are reduced.<br />- While active, the energy cost of all powers is increased and your energy generation is reduced.<br /><br />Charge<br />+ When fully charged, acrobatics activates at maximum run speed.');
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(1, 'Rank 2', 'Rank 2', 1, null, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 1, 1, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(3, 'Versatility', 'Versatility', 2, null, 'While Acrobatics is active, if you take damage you will receive a stack of Versatility, up to 5 stacks. Versatility increases your movement speed for a short time.'));
...
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(1, 'Rank 2', 'Rank 2', 1, null, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 1, 1, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(3, 'Fanfare', 'Fanfare', 0, null, 'Adds fanfare music to the activation of the power.'));
...
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(1, 'Rank 2', 'Rank 2', 1, null, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 1, 1, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(3, 'Scarab Embrace', 'Scarab Embrace', 2, null, 'While tunneling, you will gain a stack of Earthen Embrace every 3 seconds, up to 6 stacks. Earthen Embrace increases your resistance to all types of damage. These stacks will persist for a short time after you stop tunneling.'));
...
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(1, 'Rank 2', 'Rank 2', 1, null, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 1, 1, null));
dataTravelPower[dataTravelPower.length-1].advantage.push(new PowerAdvantage(3, 'Blazing Impact', 'Blazing Impact', 2, null, 'While this travel power is active, you gain a damage bonus which scales with your current speed. This bonus persists for a short time upon losing speed or stopping.'));
...
dataFramework[dataFramework.length] = new Framework(dataFramework.length, 'Bestial Supernatural', '<img src="img/Framework_BestialSupernatural.png" alt="Bestial Supernatural" />', '<b>Bestial Supernatural</b><br /><br />You have the fury and powers of a wild beast, ripping and tearing at your enemies in a vicious onslaught of animal rage. You have a diverse set of abilities, including strong crowd control and melee damage. You can easily improve your regeneration abilities.<br />Note: The Supernatural sets share several powers.<br /><br />* Recommended Characteristics: Strength and Recovery<br />* Starting Innate Talent: Feral<br />* Suggested Skill: Arms<br />* Main Damage Type: Slashing Damage<br />* Main Mechanics: ???<br />* Archetypes: The Savage');
dataFramework[dataFramework.length] = new Framework(dataFramework.length, 'Infernal Supernatural', '<img src="img/Framework_InfernalSupernatural.png" alt="Infernal Supernatural" />', '<b>Infernal Supernatural</b><br /><br />Your fiendish powers are forged from nightmare, punishing your foes with a wrathful vengeance. You have an incredibly diverse set of abilities, including excellent crowd control and strong ranged damage. You can easily improve your regeneration.<br />Note: The Supernatural sets share several powers.<br /><br />* Recommended Characteristics: Constitution and Recovery<br />* Starting Innate Talent: Inhuman<br />* Suggested Skill: Arms<br />* Main Damage Type: Toxic Damage<br />* Main Mechanics: Poison/Knocks<br />* Archetypes: The Scourge and The Cursed');
...
Power = function(id, name, desc, powerSet, framework, power, tier, tip) {
    ...
    this.toString = function() {
        ...
        advantage = advantage+'<br />]';
        return '[id='+this.id+', name=\''+this.name+'\', desc=\''+this.desc+'\', powerSet='+this.powerSet+', framework='+this.framework+', power='+this.power+', tier='+this.tier+', tip='+this.tip+', advantage='+this.advantage+', code='+this.code()+']';
    }
}
...
var dataEnergyUnlockPower = new Array();

// require group data
var dataRequireGroup = new Array();

// require group power data
var dataRequireGroupPower = new Array();
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Lightning Overload', 'Lightning Overload', 1, null, 'Grants Electric Bolt a chance to jump to another target on every attack.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Ionic Infusion', 'Ionic Infusion', 2, null, 'Doubles the chance to apply Negative Ions to your target on every attack.'));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Chain Lightning', '<img src="img/Electricity_ChainLightning.png" />&nbsp;Chain Lightning', 1, 1, pow++, 0, 'Electricity, 100 foot Ranged Single Target Damage<br /><br />Chain Lightning allows you to emit a powerful, directed blast of electrical energy at a target, which can arc to other nearby targets as well.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Never Strikes Twice', 'Never Strikes Twice', 2, null, 'Causes Lightning Arc to deal +30% damage against Held targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Sparkstorm', '<img src="img/Electricity_Sparkstorm.png" />&nbsp;Sparkstorm', 1, 1, pow++, 1, 'Electricity, 15 foot Sphere PBAoE Damage and Knock Back<br /><br />Requires 1 power from Electricity or 2 non-energy building powers from any framework.<br /><br />Sparkstorm is a shower of electrical energy which damages foes close to you. Show them that they do not want to get too close to your electric personality.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Electric Personality', 'Electric Personality', 2, null, 'Changes Sparkstorm to a toggle. The toggle has a max duration equal to the maintain limit of Sparkstorm and retains the same energy costs.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Matter – Energy Union', 'Matter – Energy Union', 2, null, 'This advantage super charges your Energy Sheath, briefly erasing the distinction between your tangible body and the energy it contains. For up to the duration of your Sheath power, incoming damage will be subtracted from your energy instead of your health. The benefit provided by this advantage can only reroute a limited amount of damage, after which damage will be dealt to you as normal.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Electric Vengeance', 'Electric Vengeance', 3, null, 'If your energy is high enough, your Electric Shield will automatically retaliate against any aggressors that are within 50 feet. Each retaliatory strike consumes an amount of energy.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Ionic Compression', 'Ionic Compression', 2, null, 'Causes Thunderstrike to root the targets hit for a short time in addition to its normal damage. Rooted targets are unable to move.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Superconductor', 'Superconductor', 2, null, 'Places a stacking debuff on the target of Electrocute which increases all Electrical damage dealt to the target by a scaling value for 20 seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Triplicity', 'Triplicity', 2, null, 'Ball Lightning now summons three Ball Lightnings instead of one, but the periodic damage each one deals is reduced by 60%. All three deal AoE damage, but only the primary one will explode.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Death Arc', 'Death Arc', 2, null, 'Any enemies killed by Gigabolt will unleash area effect damage to nearby targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Stolen Thunder', 'Stolen Thunder', 2, null, 'Your Lightning Storm hits with such force that your targets are Knocked Down on the initial impact. Additional strikes have a chance to Knock Down the targets again.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Weather the Storm'].name, dataPowerAlias['Weather the Storm'].desc, 2, null, dataPowerAlias['Weather the Storm'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Burning Desire', 'Burning Desire', 1, null, 'Gives your Throw Fire power a chance to chain into an additional target. This second shot does not generate energy, but has a chance to apply Clinging Flames.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Fuel My Fire', 'Fuel My Fire', 1, null, 'Grants Throw Fire a chance to apply Clinging Flames to your target on every attack and increases the chance to apply Clinging Flames with the initial double handed attack.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Fire Strike', '<img src="img/Fire_FireStrike.png" />&nbsp;Fire Strike', 1, 2, pow++, 0, 'Fire, 100 foot Ranged Single Target Damage and Buff<br /><br /><br />Fire Strike throws a small but volatile ball of fire at your target.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Wild Fire', 'Wild Fire', 2, null, 'If your target is affected by the Clinging Flames condition, your Fire Strike attack will refresh the Clinging Flames effect, and will cause a small mount of fire damage to all targets in a small area of effect.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Heat Wave', '<img src="img/Fire_HeatWave.png" />&nbsp;Heat Wave', 1, 2, pow++, 1, 'Fire, 50 foot Ranged Single Target Damage and Burning and Hold<br /><br />Requires 1 power from Fire or 2 non-energy building powers from any framework.<br /><br />Heat Wave directs a blast of searing air on your target, causing damage and incapacitating the target after a short time.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Engulfing Flames', 'Engulfing Flames', 2, null, 'Reduces the damage your Heat Wave deals, but applies a stacking debuff on your target that reduces their resistance to your fire damage.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Spitfire', 'Spitfire', 2, null, 'Increases the chance to apply Clinging Flames from 10% to 20%. Also guarantees the application of Clinging Flames to all targets hit by your Fire Breath when it is fully maintained.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Unstable Accelerant', 'Unstable Accelerant', 2, null, 'Your Fireball now debuffs the affects targets, causing them to take increased damage from Burning effects. Burning effects include:<br />- Clinging Flames<br />- Conflagration<br />- Fire Snake<br />- Heatwave<br />- Flashfire<br />- Pyre Burn (the patch left by Pyre)<br />- Wildfire (the AoE proc for the Fire Strike advantage)'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 2, 1,'[ID]'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Blazing Body', 'Blazing Body', 1, null, 'Adds periodic PBAoE damage while active.'));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Pyre', '<img src="img/Fire_Pyre.png" />&nbsp;Pyre', 1, 2, pow++, 2, 'Fire, 25 foot Sphere PBAoE Damage and Burning DoT<br /><br />Requires 3 powers from Fire or 4 non-energy building powers from any framework.<br /><br />Pyre turns the area around you into a raging inferno, dealing damage to any enemies around you.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Backdraft', 'Backdraft', 2, null, 'Causes your Pyre to Knock Down all affected foes. Cannot occur more than once every 5 seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Burning Rain', 'Burning Rain', 2, null, 'With this advantage, your Conflagration tracks your target\\\'s every move as long as you maintain it.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Sweltering Heat', 'Sweltering Heat', 2, null, 'Enemies affected by the Pyre created by this power will have their movement speed reduced.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Trail Blazer', 'Trail Blazer', 2, null, 'Increases the movement speed of your Fire Snake.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Energy Refraction', 'Energy Refraction', 2, null, 'Your Force Bolt attacks have a chance to create a shield around you which last for a few seconds and absorbs a modest amount of damage. This shield counts as an Energy Form.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Force Blast', '<img src="img/Force_ForceBlast.png" />&nbsp;Force Blast', 1, 3, pow++, 0, 'Force, 100 foot Ranged Single Target Damage and Knock Back<br /><br />Emits a blast of crushing energy that may well Knock your foe out of your face.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Field Inversion', 'Field Inversion', 2, null, 'This advantage causes your force blast to briefly invert the harmonics of any force field affecting your target, causing it to emit a pulse of kinetic energy, dealing damage to and around your target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Entropic Collapse', 'Entropic Collapse', 1, null, 'Your Force Snap now causes a collapse of energy around your target, Knocking Down other nearby foes.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Force Eruption', '<img src="img/Force_ForceEruption.png" />&nbsp;Force Eruption', 1, 3, pow++, 1, 'Force, 10 foot Sphere PBAoE Damage and Knock Back<br /><br />Requires 1 power from Force or 2 non-energy building powers from any framework.<br /><br />Force Eruption is an explosive blast of energy which can fling your foes away from you. We all need our personal space, and you know how to get yours.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Gravitational Polarity', 'Gravitational Polarity', 2, null, 'When Force Eruption is fully charged, this creates a "hot spot" where the eruption occurred. The spot increases all damage by 15% while the caster stands in it.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Expel Impurity', 'Expel Impurity', 2, null, 'Allows your Protection Field to remove the Burn or Bleed with the most duration left when applied.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Force Sheathe', 'Force Sheathe', 1, null, 'The Force Shield effect persists for a few seconds after you stop blocking, and it will continue to feed you energy from all incoming attacks, as well as providing a small defensive benefit.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Hard Landing', 'Hard Landing', 2, null, 'When your targets hit the ground, they always seem to land in the worst possible way. They suffer a Snare from the attack, temporarily reducing their movement speed.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Disruptive Force', 'Disruptive Force', 1, null, 'Adds a Knock Down effect to the final pulse of your Crushing Wave.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Grinding Halt', 'Grinding Halt', 2, null, 'Causes your Containment Field power to remove Travel Powers from affected targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 2, 1,'[ID]'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Power Swell', 'Power Swell', 2, null, 'Your Field Surge fills you with force energy, increasing your damage dealt by 15% for the duration.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Containment Blast', 'Containment Blast', 2, null, 'Applies a paralyze which functions like Containment Field to all targets on a full charge.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Stiff Breeze', 'Stiff Breeze', 2, null, 'Extends the chance to Disorient and Repel to every attack, instead of just the first.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Gust', '<img src="img/Wind_Gust.png" />&nbsp;Gust', 1, 4, pow++, 0, 'Wind, 100 foot Ranged Single Target Damage<br /><br />Emits a strong blast of wind that damages your foe and may Knock them away.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Toppling Winds', 'Toppling Winds', 2, null, 'Grants a 45-100% chance (based on charge time) to stagger your target, reducing their damage resistance and movement speed.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Unstable Footing', 'Unstable Footing', 2, null, 'Adds a chance to Knock Down affected targets. Targets Knocked Down by your Wind Breath will also be Staggered.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Hurricane', '<img src="img/Wind_Hurricane.png" />&nbsp;Hurricane', 1, 4, pow++, 1, 'Wind, 25 foot Sphere PBAoE Damage and Repel<br /><br />Requires 1 power from Wind or 2 non-energy building powers from any framework.<br /><br />You create a powerful storm all around you, dealing damage to your foes and Repelling them away from you.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Perfect Storm', 'Perfect Storm', 3, null, 'Your Hurricane now also deals some Electrical damage, and has a chance to apply Chill and Negative Ions to your targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Dispersal', 'Dispersal', 3, null, 'Causes your Updraft to deal 50% damage to targets withing 10 feet, and they are Knocked Up and Repelled away from your target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Vortex', 'Vortex', 2, null, 'Causes the main target of your Whirlwind to become the focus of a vortex, pulling other nearby foes toward that target.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Cold Front', 'Cold Front', 1, null, 'Adds a chance (based on charge time) for your Typhoon to Chill your target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Ionic Discharge', 'Ionic Discharge', 1, null, 'If your Typhoon hits a target affected by Negative Ions, it has a chance (based on charge time) to cause an Electric Arc to a nearby target.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Ice Impaler', 'Ice Impaler', 2, null, 'Ice Shards has a significantly increased Critical Hit Chance.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Ice Blast', '<img src="img/Ice_IceBlast.png" />&nbsp;Ice Blast', 1, 5, pow++, 0, 'Ice, 100 foot Ranged Single Target Damage and Chill<br /><br />Ice Blast allows you to hurl a concentrated bolt of frost at your target.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Hard Frost', 'Hard Frost', 2, null, 'Ice Blast does extra damage against targets that are Chilled.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Crushed Ice', 'Crushed Ice', 2, null, 'Gives Shatter a 50% chance to not consume the Chilled state from targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Frost Bite', 'Frost Bite', 2, null, 'Frost Breath is guaranteed to add the Chill effect on those it hits.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Frozen Footsteps', 'Frozen Footsteps', 2, null, 'Causes the Wall of Ice to form in your path as you move.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Sub-Zero Cellblock', 'Sub-Zero Cellblock', 2, null, 'Causes Ice Cage to interrupt any attacks being charged or maintained when it is initially applied.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Supercooled', 'Supercooled', 2, null, 'Guarantees those that attack you will have the Chill effect applied to them.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Frigid Air', 'Frigid Air', 2, null, 'Allows the Chill effect from Ice Shield to be applied up to a 50 foot range, instead of just in melee range.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Freeze, Dirtbag', 'Freeze, Dirtbag', 2, null, 'Causes Ice Burst to Paralyze the primary target, instead of Knocking them away.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Eye of the Storm', 'Eye of the Storm', 2, null, 'Causes Snow Storm to deal additional damage to targets that attack while affected by the storm.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Frigid Freedom', 'Frigid Freedom', 1, null, 'Ice Barrier no longer roots you.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Serrated Shards', 'Serrated Shards', 2, null, 'Avalanche has an increased Critical Hit Chance and increased Critical Severity.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Invigorating Chill', 'Invigorating Chill', 2, null, 'Adds an energy gain effect when you deal damage in Vapor Form.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Aversion', 'Aversion', 2, null, 'Scoring a Critical Hit with Strafe grants you Aversion, adding 20% of your intellect to your Dodge and Avoidance rating for 10 seconds. This can occur at most once every 20 seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Straight Shot', '<img src="img/Archery_StraightShot.png" />&nbsp;Straight Shot', 2, 6, pow++, 0, 'Archery, 100 foot Ranged Single Target Damage<br /><br />You fire a single arrow with deadly precision.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Split the Arrow', 'Split the Arrow', 2, null, 'Your pinpoint accuracy allows you to target the exact location you strike with this arrow, increasing the damage resistance reduction your target suffers, and causing it to affect your next 4 non-energy building direct damage Archery attacks.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Aftershock', 'Aftershock', 2, null, 'Causes your target to lose Energy and suffer additional Electrical damage over time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Deadly Dissonance', 'Deadly Dissonance', 2, null, 'Increases the Sonic AoE damage dealt by Sonic Arrow by 50% and will now stun all targets on a full charge instead of just the selected target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Fair Game', 'Fair Game', 2, null, 'When the target of your Quarry dies, you gain a small amount of Health. The amount of Health you gain scales with your Constitution.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Sleight of Mind', 'Sleight of Mind', 2, null, 'Evasive Maneuvers has a 50% chance to wipe all threat from you and places you in Stealth for 3 seconds.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Finish Him', 'Finish Him', 2, null, 'Your ability to finish off a weakened foe is increased, and Snap Shot now has an additional 35% damage bonus on targets below 25% health.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Achilles\\\' Heel', 'Achilles\\\' Heel', 2, null, 'Storm of Arrows pins all enemies in the area under attack to the ground, Rooting them in place and repairing the duration of your Roots on the target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Relentless Recurve', 'Relentless Recurve', 2, null, 'Torrent of Arrows Knocks Back all opponents hit by it.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Ballista Bolt', 'Ballista Bolt', 2, null, 'Focused Shot will pierce through enemies hitting any additional enemies in line with your initial target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Where\\\'s the Kaboom?', 'Where\\\'s the Kaboom?', 2, null, 'Explosive Arrow deals an initial amount of Piercing damage and delays the explosive effect for several seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Noxious Fumes', 'Noxious Fumes', 2, null, 'You focus the chemical mixture of your Gas Arrow to overwhelm the senses of your targets. This causes them to be Snared while inside the cloud, and they also have a 10% chance every second they are in the cloud to become Stunned for a short time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Inverse Polarization Field'].name, dataPowerAlias['Inverse Polarization Field'].desc, 2, null, dataPowerAlias['Inverse Polarization Field'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Refraction of Sound', 'Refraction of Sound', 2, null, 'Changes the Sonic Blaster power to deal damage in a cone instead of only to a single target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Experimental Blaster', '<img src="img/Gadgeteering_ExperimentalBlaster.png" />&nbsp;Experimental Blaster', 2, 7, pow++, 0, 'Gadgeteering, 100 foot Ranged Single Target Damage and Random Effects<br /><br />Experimental Blaster is a weapon of your own invention that fires a beam at your target, dealing damage and sometimes having other more... unpredictable effects.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Death Ray', 'Death Ray', 1, null, 'Doubles the chance that your Experimental Blaster deals additional damage when charged less than 1 second, and adds a very very small chance to auto-kill targets it effects. The auto-kill does not work on Master Villains and higher; instead, it deals an additional hit of damage from your blaster.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Ripsaw', 'Ripsaw', 2, null, 'Increases the damage your Gauntlet Chainsaw deals when the target is below 30% health.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Particle Mine', '<img src="img/Gadgeteering_ParticleMine.png" />&nbsp;Particle Mine', 2, 7, pow++, 1, 'Gadgeteering, Placed AoE Damage<br /><br />Requires 1 power from Gadgeteering or 2 non-energy building powers from any framework.<br /><br />Particle Mine places a mine on the ground that will explode, dealing heavy Particle damage, when an enemy comes within range.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Ejector Module', 'Ejector Module', 2, null, 'Enemies hit by Particle Mine will be knocked back in addition to taking damage.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Sapping Solution', 'Sapping Solution', 2, null, '5 seconds after being hit by the Entangling Mesh, targets become Snared by the debilitating chemicals of the mesh, causing them to move slowly for a time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Overloaded Circuits', 'Overloaded Circuits', 2, null, 'Places an active defense system in your bionic shielding, dealing Electrical damage to anyone who triggers your shield. Damage dealt is based on incoming damage.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Deafening Dissolution', 'Deafening Dissolution', 2, null, 'Your Sonic Device now deals 20% less damage with single target attacks, but deals 80% additional damage with AoE attacks.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Rejuvinating Injectors', 'Rejuvinating Injectors', 2, null, 'Causes the activation of Nanobot Swarm to grant you a heal over time buff for several seconds.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Final Delivery', 'Final Delivery', 2, null, 'Targets that are beamed into melee range will be damaged and Knocked Back.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Sonic Suppression Enhancer', 'Sonic Suppression Enhancer', 2, null, 'This modification allows your Sonic Boom Generator to focus the frequency of your Sonic attack such that your targets will be unable to focus and will be more susceptible to Sonic damage for a short period of time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Constricting Coils', 'Constricting Coils', 2, null, 'Reinforced Tanglecoil wires double the damage dealt by your Tanglecoil Launcher.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Nerve Damage', 'Nerve Damage', 2, null, 'Adds a Snare to the Toxic Nanite effect, reducing the movement speed of the target for the duration of the DoT effect. When using an AoE attack with Toxic Nanites, the duration of the Snare is reduced.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Reciprocating Gizmo', 'Reciprocating Gizmo', 2, null, 'Causes you to grow in size as your target shrinks, increasing your movement speed and damage.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Anvil of Dawn', 'Anvil of Dawn', 2, null, 'Orbital Cannon continues firing a steady beam after the initial blast. It will also chase targets, but moves slowly.<br /><br />In this mode the continuing damaging power of the cannon is effective only at the ground level.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Trick Shot', 'Trick Shot', 2, null, '50% (100% while Enraged) chance to hit an additional target within 12 feet. The additional target takes double damage if they are Feared.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Paint the Target', 'Paint the Target', 2, null, 'Each shot focuses your aim, increasing your chance to Critically Hit and your Critical Severity. This effect stacks up to 5 times, and is consumed when you perform a Critical Hit.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Close the Gap', 'Close the Gap', 2, null, 'Do more damage the closer you are to your target (up to 30% bonus damage max).'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Bullet Beatdown', '<img src="img/Munitions_BulletBeatdown.png" />&nbsp;Bullet Beatdown', 2, 8, pow++, 1, 'Munitions, 10 foot Melee Single Target Damage<br /><br />Requires 1 power from Munitions or 2 non-energy building powers from any framework.<br /><br />This gun kata uses all the resources at your disposal to take care of your enemy.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Stim Pack', 'Stim Pack', 2, null, 'You stealthily use a stim pack while rolling. The stim pack heals you over time.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Mow \'em Down', 'Mow \'em Down', 2, null, 'You have better control of your rifle while firing in a full burst, increasing how quickly your damage ramps up while maintaining the power.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Breaching Round', 'Breaching Round', 2, null, 'Provides a 100% chance to Knock Back the primary target. While Enraged, it also has a 100% chance to knock back all targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Aggression', 'Aggression', 2, null, '15% chance per tick per target to apply Bleeding to a non-Bleeding target. 100% chance vs non-Bleeding targets in melee range.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Mini Mines', '<img src="img/Munitions_MiniMines.png" />&nbsp;Mini Mines', 2, 8, pow++, 2, 'Munitions, Placed AoE Damage<br /><br />Requires 3 powers from Munitions or 4 non-energy building powers from any framework.<br /><br />When setting up a battlefield Mini Mines can be a helpful tool in weakening your enemies before they can even reach you.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Wall of Fire', 'Wall of Fire', 2, null, 'You now create two sets of Mini Mines, allowing them to cover a larger area, but each set does 40% less damage.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Concussive Rocket', 'Concussive Rocket', 2, null, 'Your rockets now Knock Back foes.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Incendiary Grenade', 'Incendiary Grenade', 2, null, 'The primary target hit by your grenade is lit on fire and receives Clinging Flames.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Listen to Reason', 'Listen to Reason', 2, null, '15% chance to apply Fear to target. Full maintain applies Enraged to self.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Escape Artist', 'Escape Artist', 2, null, 'You know how to take advantage of the momentary Blindness created by your smoke cloud. The target of your smoke grenade and anyone nearby will be unable to find you for 10 seconds, or until you damage them. A target may be affected by this effect no more than once every 30 seconds.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 2, 1,'[ID]'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Two Smoking Barrels', 'Two Smoking Barrels', 2, null, 'Whenever you hit with a melee attack, the cooldown on Lock N Load is reduced by 2 seconds. However, your Lock N Load no longer grants bonus damage to your Melee attacks.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 2, 1,'[ID]'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Microfilament Wire', 'Microfilament Wire', 2, null, 'If used within melee range of a target, the primary target will be Knocked Towards you after you land.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Tungsten Rounds', 'Tungsten Rounds', 2, null, 'Allows your Sniper Rifle shots to hit up to 3 targets in a line.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Lead Tempest', '<img src="img/Munitions_LeadTempest.png" />&nbsp;Lead Tempest', 2, 8, pow++, 3, 'Munitions, 50 foot Sphere PBAoE Damage<br /><br />Requires 5 powers from Munitions or 6 non-energy building powers from any framework.<br /><br />When you\\\'re surrounded by enemies, the ability to surround yourself with a storm of bullets can be all you need.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Tread Softly', 'Tread Softly', 2, null, 'Grants a significant bonus to Dodge and Avoidance while maintained. This bonus is doubled if you are currently Enraged.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Automated Assault', 'Automated Assault', 1, null, 'Changes the Wrist Bolter to function as a hand slot. Wrist Bolter does not generate Energy while other powers are in use.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Power Gauntlet', '<img src="img/PowerArmor_PowerGauntlet.png" />&nbsp;Power Gauntlet', 2, 9, pow++, 0, 'Power Armor, 100 foot Ranged Single Target Damage<br /><br />Power Gauntlet uses your gloves as a point to focus Particle energy before using it to blast away any foes in your path.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Downrange Disaster', 'Downrange Disaster', 2, null, 'Causes Power Gauntlet to deal less damage when you are close to the target and more damage the further you are from the target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Laser Sword', '<img src="img/PowerArmor_LaserSword.png" />&nbsp;Laser Sword', 2, 9, pow++, 1, 'Power Armor, 10 foot Melee Single Target Damage<br /><br />Requires 1 power from Power Armor or 2 non-energy building powers from any framework.<br /><br />Laser Sword creates a sword of pure Particle energy in your hand for rapid attacks against the enemy.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Particle Acceleration', 'Particle Acceleration', 2, null, 'The plasma of your blade burns with barely controlled fury. Each strike peels away your targets defenses, increasing the Particle damage they take. This increased potency, however, causes the cost of this power to increase with every strike.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Concussor Beam', '<img src="img/PowerArmor_ConcussorBeam.png" />&nbsp;Concussor Beam', 2, 9, pow++, 1, 'Power Armor, 100 foot Ranged Single Target Damage and repel<br /><br />Requires 1 power from Power Armor or 2 non-energy building powers from any framework.<br /><br />Concussor Beam shoots Particle beams from the palms of your hands at your target.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Frenetic Blast', 'Frenetic Blast', 2, null, 'Reduces the movement speed of the target of Concussor Beam for the maintained time of the power.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, '20/20 Fission', '20/20 Fission', 2, null, 'Decreases the time it takes for your Eye Beams to burn through the initial target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Laser Knight', 'Laser Knight', 3, null, 'If you have the Energy Shield power slotted, this advantage will cause it to activate when you make a melee attack, increasing your defense for a few seconds, but slightly lowering the attack\\\'s damage.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Mini Gun', '<img src="img/PowerArmor_MiniGun.png" />&nbsp;Mini Gun', 2, 9, pow++, 2, 'Power Armor, 100 foot Ranged 4 foot Cylinder AoE Damage<br /><br />Requires 3 powers from Power Armor or 4 non-energy building powers from any framework.<br /><br />Mini Gun fires a withering line of deadly lead at your target with enough power to go through the target and strike enemies behind them.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'U-238 Rounds', 'U-238 Rounds', 2, null, 'The use of depleted uranium-238 penetrators allows for better armor penetration with your Mini Gun. Through extensive testing, you\\\'re certain that no harmful side-effects will arise from their use. Well... You\\\'re pretty sure, at least.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Micro Munitions', '<img src="img/PowerArmor_MicroMunitions.png" />&nbsp;Micro Munitions', 2, 9, pow++, 2, 'Power Armor, 100 foot Ranged 10 foot Sphere AoE Damage<br /><br />Requires 3 powers from Power Armor or 4 non-energy building powers from any framework.<br /><br />Micro Munitions fires volleys of laser guided missiles at whatever is unfortunate enough to be your target.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Alpha Strike', 'Alpha Strike', 2, null, 'Damage is increased when attacking a single target, but decreased against two or more targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, 'Rank 3', 'Rank 3', 2, 1,'[ID]'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Better You Than Me', 'Better You Than Me', 2, null, 'Attacks against you while you have Unbreakable active have a chance to grant 1 stack of the Enrage buff, and to refresh all instances of that buff on yourself. This can happen at most once every 3 seconds.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Energy Wave', '<img src="img/PowerArmor_EnergyWave.png" />&nbsp;Energy Wave', 2, 9, pow++, 3, 'Power Armor, 25 foot Sphere PBAoE Damage and Knock Back<br /><br />Requires 5 powers from Power Armor or 6 non-energy building powers from any framework.<br /><br />Generating a massive surge of power you blow away the enemies surronding you.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Hardened Particle Matrix', 'Hardened Particle Matrix', 3, null, 'Your Energy Wave attack will redirect the enrgy around you into a short duration Shield which absorbs damage based on the number of targets caught in your blast.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Chest Beam', '<img src="img/PowerArmor_ChestBeam.png" />&nbsp;Chest Beam', 2, 9, pow++, 3, 'Power Armor, 50 foot Ranged 2 foot Cylinder AoE Damage and Debuff<br /><br />Requires 5 powers from Power Armor or 6 non-energy building powers from any framework.<br /><br />Chest Beam fires an unstoppable Particle blast of destruction at your enemy.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Point Blank Blast', 'Point Blank Blast', 2, null, 'Increases the damage dealt by Chest Beam the closer you are to your target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Bunker Buster', 'Bunker Buster', 2, null, 'Shoulder Launcher deals additional damage to targets using Block.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataRequireGroup['martial arts'] = new Array();
...
dataPowerAlias['Shuriken Storm'] = new PowerAlias('Shuriken Storm', 'Shuriken Storm', '<img src="img/MartialArts_ShurikenStorm.png" />&nbsp;Shuriken Storm', 'Martial Arts, 30 foot Sphere PBAoE Damage<br /><br />Requires 5 powers from Martial Arts or 6 non-energy building powers from any framework.<br /><br />You unleash a hail of shuriken all around you, attempting to hit as many targets as you can.');
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Grinning Ghost', 'Grinning Ghost', 2, null, 'With this advantage, this technique exposes weaknesses in your opponent, and sharpens your own form. Every attack has a chance to grant you a single instance of a Focus buff if you are not already affected by it or if you are affected by a Martial Arts form.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Blade Tempest', '<img src="img/DualBlades_BladeTempest.png" />&nbsp;Blade Tempest', 3, 10, pow++, 0, 'Dual Blades, 10 foot Melee 120 degree Cone AoE Damage<br /><br />Blade Tempest is a deadly combination of whirling two blade attacks.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Crashing Crescendo', 'Crashing Crescendo', 2, null, 'Each hit with Blade Tempest adds a stacking buff which increases your chance to Critically Hit. All stacks of the buff are removed upon a successful critical hit.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Red-Eyed Dragon', 'Red-Eyed Dragon', 2, null, 'Storm\\\'s Harvest will always be a Critical Hit, however, after each use you will not be able to Critically Hit with any power for 5 seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Chained Kunai'].name, dataPowerAlias['Chained Kunai'].desc, 2, null, dataPowerAlias['Chained Kunai'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Instep Crush'].name, dataPowerAlias['Instep Crush'].desc, 2, null, dataPowerAlias['Instep Crush'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Concussive Escape'].name, dataPowerAlias['Concussive Escape'].desc, 2, null, dataPowerAlias['Concussive Escape'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Gifts of the Storm', 'Gifts of the Storm', 3, null, 'It is the essential nature of a Master of the Tempest style to project everything that they are and have outwards. Against their enemies, practitioners of this style give gifts of their skill and steel, bringing death and justice. With this technique, the enlightened Tempest learns how to harness their Chi to extend this principle, sharing any healing you receive with your allies.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['The Elusive Monk'].name, dataPowerAlias['The Elusive Monk'].desc, 3, null, dataPowerAlias['The Elusive Monk'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Essence Assault'].name, dataPowerAlias['Essence Assault'].desc, 3, null, dataPowerAlias['Essence Assault'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Tiger\'s Courage', 'Tiger\'s Courage', 2, null, 'Dragon\\\'s Wrath has its damage increased by a factor of your current chance to land a Critical Hit.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Flowing Strikes'].name, dataPowerAlias['Flowing Strikes'].desc, 2, null, dataPowerAlias['Flowing Strikes'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';

dataPower[dataPower.length] = new Power(dataPower.length, 'Eye of the Storm', '<img src="img/DualBlades_EyeOfTheStorm.png" />&nbsp;Eye of the Storm', 3, 10, pow++, 2, 'Dual Blades, 10 foot Sphere PBAoE Damage and shield<br /><br />Requires 3 powers from Dual Blades or 4 non-energy building powers from any framework.<br /><br />Eye of the Storm uses your weapons to surround you in a whirling shield of cutting blades.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Blade Beyond the Veil', 'Blade Beyond the Veil', 2, null, 'Eye of the Storm deals damage to enemies attacking you in melee range for the duration of the maintain.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Resurgent Reiki'].name, dataPowerAlias['Resurgent Reiki'].desc, 2, null, dataPowerAlias['Resurgent Reiki'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Silent Running'].name, dataPowerAlias['Silent Running'].desc, 1, null, dataPowerAlias['Silent Running'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Unfettered Strikes'].name, dataPowerAlias['Unfettered Strikes'].desc, 2, null, dataPowerAlias['Unfettered Strikes'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';

dataPower[dataPower.length] = new Power(dataPower.length, 'Sword Cyclone', '<img src="img/DualBlades_SwordCyclone.png" />&nbsp;Sword Cyclone', 3, 10, pow++, 3, 'Dual Blades, 10 foot Melee 15 foot Sphere AoE Damage<br /><br />Requires 5 powers from Dual Blades or 6 non-energy building powers from any framework.<br /><br />Sword Cyclone is a difficult technique allowing a weapons master to deliver devastation to all around them by spinning rapidly with their weapons extended.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Butcher\'s Blades', 'Butcher\'s Blades', 2, null, 'Sword Cyclone becomes a charge power instead of maintain.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Floating Butterfly'].name, dataPowerAlias['Floating Butterfly'].desc, 2, null, dataPowerAlias['Floating Butterfly'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
dataRequireGroupPower[dataPower.length-1] = 'martial arts';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Real Ultimate Power'].name, dataPowerAlias['Real Ultimate Power'].desc, 2, null, dataPowerAlias['Real Ultimate Power'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Peerless Predation', 'Peerless Predation', 2, null, 'With this advantage, this technique exposes weaknesses in your opponent, and sharpens your own form. Every attack has a chance to grant you a single instance of a Focus buff if you are not already affected by it or if you are affected by a Martial Arts form.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Viper\'s Fangs', '<img src="img/FightingClaws_VipersFangs.png" />&nbsp;Viper\'s Fangs', 3, 11, pow++, 0, 'Fighting Claws, 10 foot Melee Single Target Damage and debuff<br /><br />Viper\\\'s Fangs is a brutal slashing claw attack with the potential to utilize your Chi energy to inflict a venomous wound on your enemy.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Spitting Cobra', 'Spitting Cobra', 2, null, 'Grants each attack with Viper\\\'s Fangs a chance to apply Deadly Poison, which stacks up to 10 times and causes your target to suffer Toxic damage over time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Drake\'s Deliverance', 'Drake\'s Deliverance', 2, null, 'Rend and Tear does 30% bonus damage, but does the damage over time after the initial hit.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Rage of the Beast', 'Rage of the Beast', 2, null, 'A practitioner of the Form of the Tiger may channel the pure rage of a great beast when threatened with imprisonment.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Vertebreak', 'Vertebreak', 2, null, 'Dragon\\\'s Claws will Knock Down the target 3 times over the 3 seconds following the attack. The Knock Down cannot occur more than once every 60 seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Mouth of Madness', 'Mouth of Madness', 2, null, 'Tiger\\\'s Bite has a chance to not consume the Shredded effect on the targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Three Edged Blade', 'Three Edged Blade', 2, null, 'With this advantage, this technique exposes weaknesses in your opponent, and sharpens your own form. Every attack has a chance to grant you a single instance of a Focus buff if you are not already affected by it or if you are affected by a Martial Arts form.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Reaper\'s Caress', '<img src="img/SingleBlade_ReapersCaress.png" />&nbsp;Reaper\'s Caress', 3, 12, pow++, 0, 'Single Blade, 10 foot Melee Single Target Damage<br /><br />Reaper\\\'s Caress is a rapid series of attacks capable of leaving the enemy with multiple bleeding wounds.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Cleaving Strikes', 'Cleaving Strikes', 2, null, 'Reaper\\\'s Caress becomes a cone power and the cost is increased by 50%. The Bleed on the third hit will still only hit your primary target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Cut Where it Counts', 'Cut Where it Counts', 2, null, 'The cuts of a master of the Form of the Swordsman strike the most vital areas of their targets, resulting in wounds that are frighteningly difficult to heal.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'No Mercy', 'No Mercy', 2, null, '5-50% chance (based on charge time) to cause 2 Bleeds to your target.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Drunken Master', 'Drunken Master', 2, null, 'With this advantage, this technique exposes weaknesses in your opponent, and sharpens your own form. Every attack has a chance to grant you a single instance of a Focus buff if you are not already affected by it or if you are affected by a Martial Arts form.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Thundering Kicks', '<img src="img/Unarmed_ThunderingKicks.png" />&nbsp;Thundering Kicks', 3, 13, pow++, 0, 'Unarmed, 10 foot Melee Single Target Damage and Dodge Buff<br /><br />Thundering Kicks unleashes a flurry of pounding kicks on your enemy.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Floating Lotus Blossom', 'Floating Lotus Blossom', 2, null, 'Each successful hit with Thundering Kicks adds a stacking Dodge buff to you. All stacks of the buff are removed upon a successful Dodge.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Subtlety of the Tides', 'Subtlety of the Tides', 2, null, 'For 8 seconds after using Crashing Wave Kick, all of your melee attacks have a 50% chance to grant a stack of Ebb and Flow which is a small Dodge and Avoidance buff. The amount of Dodge and Avoidance granted is increased slightly as you level.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Storm\'s Eye Prana', 'Storm\'s Eye Prana', 3, null, 'A dedicated practitioner of the Form of the Master style gains strength among enemies, and is serene in the eye of the storm.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Stinging Bee', 'Stinging Bee', 2, null, 'Sets you up for additional attacks, granting you a stack of Focus.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Falling Hammer', 'Falling Hammer', 2, null, 'You deal an additional 30% damage with this power when your target is Knocked or Stunned.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Lashing Dragon Tail', 'Lashing Dragon Tail', 2, null, 'Dragon Kick increases the amount of damage you are able to Dodge from attacks.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Fists of Righteous Flame', 'Fists of Righteous Flame', 2, null, 'If fully charged, Burning Chi Fist grants a short duration buff with each use which grants a chance to add Dimensional damage to each melee attack.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Focused Chi Blast', 'Focused Chi Blast', 2, null, 'Causes your Open Plan Strike to unleash a powerful blast of Chi energy in a line in front of you. This advantage causes your attack to now deal half damage as Physical damage to your primary target, and the other half as Dimensional damage to all affected targets in a 25 foot line in front of you, including the primary target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Leeching Strikes', 'Leeching Strikes', 2, null, 'All attacks of this combo gain a 15% chance to grant you a stack of Ego Leech, instead of just the initial attack.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Incisive Wit', 'Incisive Wit', 2, null, '+ Gives this power a 15% chance to activate an Id Surge.<br />+ Cannot occur more than once every 20 seconds.<br />+ Increases all Paranormal (Dimensional, Ego, Magic) damage.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Weaponry', '<img src="img/Telekinesis_EgoWeaponary.png" />&nbsp;Ego Weaponry', 4, 14, pow++, 0, 'Telekinesis, 10 foot Melee Single Target Damage<br /><br />Make a weapon from your force of will. This Ego Weaponry will be used in melee, driving the strength of your mind against the physical form of your opponent.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Thought Sever', 'Thought Sever', 1, null, 'Ego Weaponry will reduce the energy of the target with each hit in addition to dealing damage normally. Also causes your Ego Weaponry to deal an additional 20% damage to targets with less than 50% energy.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Siphoning Strikes', 'Siphoning Strikes', 3, null, 'Your Ego Weaponry attacks no longer deal additional damage when you perform a critical strike with them. Instead, you heal yourself for the amount of additional damage you would have done when performing a critical strike.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Explosive Potential', 'Explosive Potential', 2, null, 'Your Telekinetic Assault now does a burst of AoE damage around your primary target, hitting other nearby does within 10 feet.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Unnerving Rage', 'Unnerving Rage', 2, null, 'Causes Ego Blade Frenzy to Root its target for the duration of the attack.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Sudden Impact', 'Sudden Impact', 2, null, 'Your Telekinetic Burst hits with such strength that affected targets are Knocked Down.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Id Blades', 'Id Blades', 0, null, 'While this power is active, your Ego Blade powers manifest Dual Id Blades instead of a single Ego Blade.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Telekinetic Reinforcement', 'Telekinetic Reinforcement', 1, null, 'Telekinetic Shield will continue to provide a defensive benefit against all damage for a short time after blocking.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Head Shot', 'Head Shot', 2, null, 'Ego Blade Dash will also Disorient your target if you lunge more than 20 feet.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Eruption', '<img src="img/Telekinesis_TelekineticEruption.png" />&nbsp;Telekinetic Eruption', 4, 14, pow++, 2, 'Telekinesis, 10 foot Sphere PBAoE Damage<br /><br />Requires 3 powers from Telekinesis or 4 non-energy building powers from any framework.<br /><br />You gather your will and then release it in a massive blast. This blast deals a large amount of damage, and has a chance of Knocking Back your foes.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Enhanced Form', 'Enhanced Form', 2, null, 'The Ego Form resulting from charging Telekinetic Eruption lasts longer than usual.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Psychic Tides', 'Psychic Tides', 2, null, 'Telekinetic Wave will decrease the energy equilibrium of targets to 1 for 16 seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Choke', '<img src="img/Telekinesis_EgoChoke.png" />&nbsp;Ego Choke', 4, 14, pow++, 2, 'Telekinesis, 50 foot Ranged Single Target Damage and Hold<br /><br />Requires 3 powers from Telekinesis or 4 non-energy building powers from any framework.<br /><br />Having learned your lessons well, you may use your telekinetic powers to choke a single foe.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Garroting Grip', 'Garroting Grip', 2, null, 'Choke Hold reduces the offensive capabilities of your target for a short duration.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Mass Effect', 'Mass Effect', 2, null, 'Mass Effect causes the target of your Ego Hold and enemies near your Ego Hold target to become Snared, reducing their movement speed for a time.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Nimble Mind', 'Nimble Mind', 2, null, 'Your Ego Surge greatly enhances your ability to deliver Critical Strikes.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Domineering Will', 'Domineering Will', 1, null, 'Ego Blade Breach will Stun targets who block the attack.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Mental Acuity', 'Mental Acuity', 2, null, 'Your focus doubles the bonus damage this power deals for each stack of Ego Leech it consumes and increases the damage your Ego Annihilation deals by 50%.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Id Infusion', 'Id Infusion', 2, null, 'The Ego Infusion Buff granted by consuming stacks of Ego Leech with this power now also grants a 15% increase to all Ego Damage while it is active.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Maelstrom', '<img src="img/Telekinesis_TelekineticMaelstrom.png" />&nbsp;Telekinetic Maelstrom', 4, 14, pow++, 3, 'Telekinesis, 25 foot Sphere PBAoE Damage and Stun<br /><br />Requires 5 powers from Telekinesis or 6 non-energy building powers from any framework.<br /><br />This telekinetic attack draws stones from the earth, and flings them at nearby enemies.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Expansive Intellect', 'Expansive Intellect', 2, null, 'Increases the radius of the Telekinetic Maelstrom AoE by 10 feet.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Aggression Inhibitor'].name, dataPowerAlias['Aggression Inhibitor'].desc, 2, null, dataPowerAlias['Aggression Inhibitor'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Psychic Reverberations', 'Psychic Reverberations', 2, null, 'Psi Lash has a chance to buff your Ego damage.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Blast', '<img src="img/Telepathy_EgoBlast.png" />&nbsp;Ego Blast', 4, 15, pow++, 0, 'Telepathy, 100 foot Ranged Single Target Damage and Disorient<br /><br />');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Mind Opener', 'Mind Opener', 2, null, 'Damage dealt by Ego Blast is increased 30% while you are affected by Telepathic Reverberation.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Rude Awakening', 'Rude Awakening', 1, null, 'Your mental assault is easier to perform on Sleeping targets, causing Ego Blast to deal 15% more damage to them.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Svengali\'s Guile', 'Svengali\'s Guile', 2, null, 'Placated enemies have their defenses reduced.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Plagued by Nightmares', 'Plagued by Nightmares', 2, null, 'Ego Sleep plagues the target with terrifying nightmares while asleep, affecting them with Fear when they wake up.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Empathic Amplification', 'Empathic Amplification', 2, null, 'When you heal someone else with Empathic Healing, you transfer the pain to yourself. You can then redirect this pain through your own attacks for a short period of time. Failing to redirect the pain quickly enough will cause you to take damage.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Befuddling Rage', 'Befuddling Rage', 2, null, 'Confused enemies have their combat stats increased for the duration of the confuse effect.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Single Minded', 'Single Minded', 2, null, 'Targets who are close to the Psychic Vortex have a chance to be Stunned.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Night Terror', 'Night Terror', 2, null, 'Nightmare entities have their life span increased. They will now attack the target until it is defeated instead of disappearing partway through the fight.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Psionic Emanation', 'Psionic Emanation', 2, null, 'Grants your Psionic Healing a chance to perform an AoE heal around the target.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Storm', '<img src="img/Telepathy_EgoStorm.png" />&nbsp;Ego Storm', 4, 15, pow++, 3, 'Telepathy, 25 foot Sphere PBAoE Damage and Hold<br /><br />Requires 5 powers from Telepathy or 6 non-energy building powers from any framework.<br /><br />Summon a storm of mental energy and press it into action, damaging the foes daring enough to come close to you.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Malevolent Manifestation', 'Malevolent Manifestation', 2, null, 'Your Ego Storm becomes its own entity and will blast your enemies without your assistance after being created. This advantage increases the cost of Ego Storm by 20%, and will cause Ego Storm to be incapable of getting a Critical Hit.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Consume Will', 'Consume Will', 2, null, 'Causes the entities summoned by Collective Will to debuff their targets, lowering their resistance to Ego damage by 10%.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Revitalizing Boost', 'Revitalizing Boost', 2, null, 'If your Mindful Reinforcement shield absorbs the full amount it restores energy to you.'));
...
dataRequireGroup['brick'] = new Array();
...
dataPowerAlias['Enrage'] = new PowerAlias('Enrage', 'Enrage', '<img src="img/Brick_Enrage.png" />&nbsp;Enrage', 'Brick, Self Buff<br /><br />Requires 3 powers from Brick or 4 non-energy building powers from any framework.<br /><br />Enrage sends you into a frenzy, increasing your damage and causing any damage dealt to you to only make you fight harder.');
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Until Morale Improves', 'Until Morale Improves', 2, null, 'All attacks of this combo gain a 15% chance to Disorient the primary target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Cleave', '<img src="img/HeavyWeapon_Cleave.png" />&nbsp;Cleave', 5, 16, pow++, 0, 'Heavy Weapon, 10 foot Melee 120 degree Cone AoE Damage and Enrage<br /><br />You assault your foes with a series of powerful horizontal strikes.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Defensive Stance', 'Defensive Stance', 2, null, 'Finishing this combo against a Disoriented target will apply/refresh Defiance on yourself.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Magma Burst', 'Magma Burst', 2, null, 'Causes a burst of magma to explode on your target, dealing Fire damage in a 10 foot sphere centered on your target, potentially setting those targets on fire.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Concussion', 'Concussion', 2, null, 'Applies or refreshes Trauma on your target. Trauma ends any healing over time effects on your target, and causes them to receive only 50% benefit from any other incoming heals.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Force of Will'].name, dataPowerAlias['Force of Will'].desc, 2, null, dataPowerAlias['Force of Will'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Punitive Pummeling', 'Punitive Pummeling', 2, null, 'Attacks against you have a chance of reflecting their energy outwards. Every incoming attack that you block with Guard has a 20% change of knocking back all nearby enemies. This effect can occur at most once every 10 seconds.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Restraining Order', 'Restraining Order', 2, null, 'When lunging from more than 20 feet away, you temporarily cripple the target\\\'s legs, Rooting them in place for a short time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'No Quarter', 'No Quarter', 2, null, 'Your strike temporarily reduces your target\\\'s resistance to all Physical damage.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Put Them Down', 'Put Them Down', 1, null, 'You are able to take advantage of your foe\\\'s weakened state, allowing your Skullcrusher to deal an additional 15% damage to Disoriented targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Follow Through', 'Follow Through', 1, null, 'You plant your feet firmly on the ground, bracing yourself for the attack, increasing the Charge damage of Skewer by 25%.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Initiative', 'Initiative', 1, null, 'You let loose with a quick burst of strength, increasing the Tap (and base) damage of Skewer by 15%.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Endorphin Rush'].name, dataPowerAlias['Endorphin Rush'].desc, 2, null, dataPowerAlias['Endorphin Rush'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['Giant Growth'].name, dataPowerAlias['Giant Growth'].desc, 0, null, dataPowerAlias['Giant Growth'].tip));
dataRequireGroupPower[dataPower.length-1] = 'brick';
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Brimstone', '<img src="img/HeavyWeapon_Brimstone.png" />&nbsp;Brimstone', 5, 16, pow++, 3, 'Heavy Weapon, 10 foot Melee 10 foot Sphere PBAoE Damage and Knock Down<br /><br />Requires 5 powers from Heavy Weapon or 6 non-energy building powers from any framework.<br /><br />You raise your weapon to the sky, charging it with energy that you strike down with, damaging nearby foes.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Aftershock', 'Aftershock', 2, null, 'Fully charing Brimstone will now leave a patch of fire on the ground, burning nearby foes. Only 1 patch may exist at a time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Bend the Earth', 'Bend the Earth', 2, null, 'Targets further than 25 feet from you are Knocked Towards you instead of up.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Vicious Descent', '<img src="img/HeavyWeapon_ViciousDescent.png" />&nbsp;Vicious Descent', 5, 16, pow++, 3, 'Heavy Weapon, 60 foot Lunge 10 foot Sphere PBAoE Damage<br /><br />Requires 5 powers from Heavy Weapon or 6 non-energy building powers from any framework.<br /><br />You leap into the air, crashing down on your foes with your weapon.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Relentless', 'Relentless', 2, null, 'Affected targets are Knocked Down.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Faltering Strikes', 'Faltering Strikes', 2, null, 'All Wield Earth attacks now have a chance to Stagger your foe, instead of just the opening attack.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Stone Shot', '<img src="img/Earth_StoneShot.png" />&nbsp;Stone Shot', 5, 17, pow++, 0, 'Earth, 100 foot Ranged 0-10 foot Sphere AoE Damage and Stagger<br /><br />After pressing nearby earth into a dense ball you launch it at your foes.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Shard Burst', 'Shard Burst', 2, null, 'Increases the Crushing AoE damage dealt by Stone Shot by 50% and will now Stagger all targets on a full charge instead of just the selected target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Excessive Force', 'Excessive Force', 2, null, 'When your Onslaught applies Stagger, it now deals double damage and Knocks your foe down.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Rupture', 'Rupture', 2, null, 'If fully charged and your primary target is Staggered, Tremor applies a stack of Stagger to all targets hit.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Aggressive Gravitation', 'Aggressive Gravitation', 2, null, 'If fully charged and used against a Staggered target, your stacks of Stagger on the target are consumed and turned into stacks of Enraged on you.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Quicksand', '<img src="img/Earth_Quicksand.png" />&nbsp;Quicksand', 5, 17, pow++, 2, 'Earth, 10-25 foot Sphere PBAoE Damage and Slow<br /><br />Requires 3 powers from Earth or 4 non-energy building powers from any framework.<br /><br />Cause the earth around you to become a quagmire that damages foes as it slowly seeps outward.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Repulsing Waves', 'Repulsing Waves', 2, null, 'Quicksand will now repel foes away from you instead of pulling them towards you. (Will not push them out of maximum range of the power.) Quicksand also gains a chance to Stagger for all foes hit.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Seismic Smash', '<img src="img/Earth_SeismicSmash.png" />&nbsp;Seismic Smash', 5, 17, pow++, 2, 'Earth, 25 foot Lunge 15 foot Sphere PBAoE Damage<br /><br />Requires 3 powers from Earth or 4 non-energy building powers from any framework.<br /><br />Crush your enemy between a rock and a hard place as you blast them through a stone wall.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Massive Attack', 'Massive Attack', 2, null, 'Removes AoE component of the power, causing it to deal 60% more damage.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Reconstruct', 'Reconstruct', 2, null, 'Standing in your Fissure will heal you over time. If you are actively using Stone Shroud, this effect is doubled.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Compound Fracture', 'Compound Fracture', 2, null, 'If fully charged, targets will become Rooted instead of Knocked Up. When the Root expires, the target will be Knocked Up.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Onslaught', 'Onslaught', 2, null, 'Adds a 10% chance to grant you a stack of Enrage if you are not already Enraged. If you are Enraged it will instead refresh your stacks of Enrage.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Beatdown', '<img src="img/Might_Beatdown.png" />&nbsp;Beatdown', 5, 18, pow++, 0, 'Might, 10 foot Melee Single Target Damage and Stun<br /><br />Beatdown delivers blows powerful enough to Stun anyone on the receiving end.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Blindside Blow', 'Blindside Blow', 3, null, 'Causes your Beatdown attack to deal 50% additional damage to Snared or Rooted enemies.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Surge of Strength', 'Surge of Strength', 2, null, 'Defensive Combo attacks now apply or refresh the Defiant buff on each attack. Defensive Combo will never apply more than 1 stack of Defiant, but it will refresh any number of existing applications of Defiant.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Madness', 'Madness', 2, null, 'Hitting a foe with fully charged Mighty Kick will now add or refresh the Defiant buff.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Rubble Trouble', 'Rubble Trouble', 2, null, 'Causes your Hurl attack to hit additional targets around your primary target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Kyoketsu Shoge', 'Kyoketsu Shoge', 2, null, 'Adds a 1 second charge. Full charge does considerably more damage but does not pull target. All hits cause Bleeding.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Concussive Blow', 'Concussive Blow', 2, null, 'Adds a short Stun to your Roomsweeper. This cannot occur more than once every 10 seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Iron Cyclone', '<img src="img/Might_IronCyclone.png" />&nbsp;Iron Cyclone', 5, 18, pow++, 1, 'Might, 10 foot Sphere PBAoE Damage<br /><br />Requires 1 power from Might or 2 non-energy building powers from any framework.<br /><br />Iron Cyclone swings a heavy chain around you, lashing out at any enemies that come within its path.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Vortex Technique', 'Vortex Technique', 2, null, 'Iron Cyclone becomes a Knock Towards instead of a Knock Away. Maintaining for at least 2 seconds applies or refreshed Enraged.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Punitive Pummeling', 'Punitive Pummeling', 2, null, 'Attacks against you have a chance of reflecting their energy outwards. Every incoming attack that you block with retaliation has a 20% chance of Knocking Back all nearby enemies. This effect can occur at most once every 10 seconds.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Bull Rush', 'Bull Rush', 2, null, 'Adds a Knock Back and Snare effect to your Mighty Leap attack that affects any enemies near your primary target.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Head Trauma', 'Head Trauma', 2, null, 'Uppercut leaves the target Disoriented, and makes focusing painful. If the target charges up powers while Disoriented, they will be Stunned. Can only occur once every 20 seconds.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Below the Belt', 'Below the Belt', 2, null, 'Decrease the targets crushing damage mitigation by an amount based on the time Demolish is charged. This reduction is in addition to the damage mitigation reduction inherent in the original power.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Thunderclap', '<img src="img/Might_Thunderclap.png" />&nbsp;Thunderclap', 5, 18, pow++, 2, 'Might, 10 foot Melee 10 foot Sphere PBAoE Damage and Stun<br /><br />Requires 3 powers from Might or 4 non-energy building powers from any framework.<br /><br />Thunderclap slams your hands together to generate a stunning shockwave.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Collateral Damage', 'Collateral Damage', 2, null, 'Increases the range of Thunderclap to 15 feet. The damage within 10 feet remains melee Crushing damage. The damage on the outer 5 feet is ranged Sonic damage.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Nullifying Punch', 'Nullifying Punch', 2, null, 'Applies or refreshes Trama on your target. Trama ends any healing over time effects on your target, and causes them to receive only 50% benefit from any other incoming heals.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Havoc Stomp', '<img src="img/Might_HavocStomp.png" />&nbsp;Havoc Stomp', 5, 18, pow++, 3, 'Might, 10 foot Sphere PBAoE Damage and Knock<br /><br />Requires 5 powers from Might or 6 non-energy building powers from any framework.<br /><br />Havoc Stomp slams your feet into the ground sending a shockwave surging out around you.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Cry Havoc', 'Cry Havoc', 2, null, 'Targets knocked back by Havoc Stomp are also affected by Fear.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Leg Rumbler', 'Leg Rumbler', 1, null, 'Removes travel powers from targets hit by Shockwave.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Convergence', 'Convergence', 2, null, 'Radiance gains a 20% chance to chain to a secondary target. The chain will have the opposite effect: An attack will chain a heal to a nearby friend; a heal will chain an attack to a nearby enemy.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Rebuke', '<img src="img/Celestial_Rebuke.png" />&nbsp;Rebuke', 6, 19, pow++, 0, 'Celestial, 100 foot Ranged Single Target Damage and Heal<br /><br />Call upon dimensional forces to judge your target, healing your friends and destroying your foes.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Admonish', 'Admonish', 2, null, 'When fully charged, Rebuke now Stuns foes within 10 feet of the primary target (the primary target is not Stunned). This effect is active for both healing and damage forms.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Serenity', 'Serenity', 2, null, 'A portion of the energy you use to cast Celestial Conduit is returned if your target is affected by the heal component of Mend. The energy returned scales slightly with your Constitution.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Redemption Denied', 'Redemption Denied', 2, null, 'On a full charge, Vengeance now Paralyzes your primary target and Stuns any other affected targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Justice', 'Justice', 2, null, 'Inquity can now target up to 5 friends in a cone in front of you. Iniquity is less effective (per target) for each target hit beyond the first.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Reverence', 'Reverence', 2, null, 'Adds a small AoE (15 foot radius, max of 5 targets) heal component to Conviction.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Illusive', 'Illusive', 2, null, 'Activating Imbue will cause you to generate less threat for 10 seconds.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Balance', 'Balance', 2, null, 'This advantage improves the healing aura effect of your Seraphim power. While you are in combat and Seraphim is active, up to 5 enemy targets within 25 feet of you will take a small amount of damage over time.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Brilliance', 'Brilliance', 2, null, 'Illumination now affects up to 5 targets (of the same type, either all friends or all foes) in a 15 foot radius around your primary target.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Expulse', '<img src="img/Celestial_Expulse.png" />&nbsp;Expulse', 6, 19, pow++, 2, 'Celestial, 15 foot Sphere PBAoE Damage and Knock Back<br /><br />Requires 3 powers from Celestial or 4 non-energy building powers from any framework.<br /><br />Using a blast of energy you are able to send any enemies around you flying.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Impose', 'Impose', 2, null, 'All targets hit by Expulse are Snared after 2 seconds, reducing their movement speed for a time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Redemption', '<img src="img/Celestial_Redemption.png" />&nbsp;Redemption', 6, 19, pow++, 2, 'Celestial, 15 foot Sphere PBAoE Revive<br /><br />Requires 3 powers from Celestial or 4 non-energy building powers from any framework.<br /><br />Your powers allow you to call other heroes back from the brink of defeat.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Salvation', 'Salvation', 2, null, 'Redemption can now resurrect up to 4 teammates within 25 feet of you. Healing received is divided amongst targets resurrected.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Absolve', 'Absolve', 2, null, 'The target of Palliate has their threat wiped and gains stealth for 10 seconds.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Deliverance', 'Deliverance', 2, null, 'Celestial Cleansing now helps friendly targets around your primary target break free of holds.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Judgment', 'Judgment', 2, null, 'All Illuminations within 25 feet are consumed. Friendly targets who were Illuminated are healed. Enemy targets who were Illuminated take damage.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Double Vortex'].name, dataPowerAlias['Double Vortex'].desc, 2, null, dataPowerAlias['Double Vortex'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Despondency', 'Despondency', 2, null, 'Decreases target\\\'s Dodge chance. Additionally, all Shadow Bolt attacks now have a chance to apply Fear (instead of only the opening attack).'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Shadow Blast', '<img src="img/Darkness_ShadowBlast.png" />&nbsp;Shadow Blast', 6, 20, pow++, 0, 'Darkness, 100 foot Ranged Single Target Damage and Fear<br /><br />Shadow Blast is a highly focused bolt of dimensional energies. Few enemies can stand in its path and survive.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Psychotic Break', 'Psychotic Break', 2, null, 'Full charge vs Feared target pushes them into full on psychosis, Stunning the target and dealing additional Dimensional damage over time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Dark Displacement', 'Dark Displacement', 2, null, 'Adds a chance to Knock Down your targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Fatal Allure', 'Fatal Allure', 1, null, 'Feared targets are Knocked Toward you with great force, potentially pulling them clear over your head.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(7, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Unyielding Agony', 'Unyielding Agony', 2, null, 'Grasping Shadows now deals damage over time. This damage does not reduce the durability of the Paralyze Hold applied by Grasping Shadows.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Emerging Nightmares', 'Emerging Nightmares', 2, null, 'Close contact with the Void reaches into your foes\\\' minds and triggers deep-seated fears to emerge.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Vampiric Sympathy', 'Vampiric Sympathy', 2, null, 'The heal component of your Lifedrain becomes an AoE (15 foot radius, max of 5 targets) centered on you that heals nearby friends for half as much as it heals you. When using Lifedrain on a Feared target, the AoE heals for as much as it heals you.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Blood Sacrifice', 'Blood Sacrifice', 2, null, 'Activating Dark Transfusion with the Blood Sacrifice advantage increases the damage of all of your attacks, up to a specific amount of total damage (approximately equal to a Shadow Blast at your level).'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Nyctophobia', 'Nyctophobia', 1, null, 'Increases the damage of Ebon Ruin by 15% against Feared targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, 'Paranormal Paranoia', 'Paranormal Paranoia', 2, null, 'Your Ebon Ruin now reduces the target\\\'s resistance to Paranormal (Dimensional, Ego, Magic) damage.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Vengeful Shadows', 'Vengeful Shadows', 2, null, 'Targets that get too close to the Rift will take massive Dimensional damage and be Knocked Back. Targets that are immune to Knock Back will instead take some additional damage if they are too close.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Devouring Darkness', 'Devouring Darkness', 2, null, 'Causes the damage your Shadows deal to heal you for 20% of the damage they deal.'));
...
dataRequireGroup['sorcery'] = new Array();
...
dataPowerAlias['Eldritch Blast'] = new PowerAlias('Eldritch Blast', 'Eldritch Blast', '<img src="img/Sorcery_EldritchBlast.png" />&nbsp;Eldritch Blast', 'Sorcery, 100 foot Ranged Single Target Damage and Root<br /><br />Eldritch Blast fires a concentrated blast of eldritch energy at your enemy.');
...
dataPowerAlias['Pillar of Poz'] = new PowerAlias('Pillar of Poz', 'Pillar of Poz', '<img src="img/Sorcery_PillarOfPoz.png" />&nbsp;Pillar of Poz', 'Sorcery, 15 foot Sphere PBAoE Damage and Knock Back<br /><br />Requires 1 power from Sorcery or 2 non-energy building powers from any framework.<br /><br />Call upon the immense power of Poz to Knock your foes away from you.');
...
dataPowerAlias['Binding of Aratron'] = new PowerAlias('Binding of Aratron', 'Binding of Aratron', '<img src="img/Sorcery_BindingOfAratron.png" />&nbsp;Binding of Aratron', 'Sorcery, 50 foot Single Target Hold<br /><br />Requires 1 power from Sorcery or 2 non-energy building powers from any framework.<br /><br />Binding of Aratron channels eldritch energy to lock your enemy to the ground.');
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Wizards Discretion'].name, dataPowerAlias['Wizards Discretion'].desc, 2, null, dataPowerAlias['Wizards Discretion'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Sorcerers Whim'].name, dataPowerAlias['Sorcerers Whim'].desc, 2, null, dataPowerAlias['Sorcerers Whim'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Sigils of Arcane Runes', '<img src="img/Sorcery_SigilsOfArcaneRunes.png" />&nbsp;Sigils of Arcane Runes', 6, 21, pow++, 1, 'Arcane Sorcery, Sigils AoE Damage<br /><br />Requires 1 power from Arcane Sorcery or 2 non-energy building powers from any framework.<br /><br />Sigils of Arcane Runes summons 5 unstable sigils that will violently explode whenever an enemy comes near.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Mystic Transference'].name, dataPowerAlias['Mystic Transference'].desc, 1, null, dataPowerAlias['Mystic Transference'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Dizzying Impact'].name, dataPowerAlias['Dizzying Impact'].desc, 2, null, dataPowerAlias['Dizzying Impact'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Tenable Bonds'].name, dataPowerAlias['Tenable Bonds'].desc, 2, null, dataPowerAlias['Tenable Bonds'].tip));
dataRequireGroupPower[dataPower.length-1] = 'sorcery';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Imbue With Power'].name, dataPowerAlias['Imbue With Power'].desc, 2, null, dataPowerAlias['Imbue With Power'].tip));
dataRequireGroupPower[dataPower.length-1] = 'sorcery';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Impart Freedom', 'Impart Freedom', 2, null, 'Your Arcane Vitality will now remove all control effects at the end of a full maintain.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Unbound Ritual'].name, dataPowerAlias['Unbound Ritual'].desc, 2, null, dataPowerAlias['Unbound Ritual'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Warlocks Malice'].name, dataPowerAlias['Warlocks Malice'].desc, 2, null, dataPowerAlias['Warlocks Malice'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
dataRequireGroupPower[dataPower.length-1] = 'sorcery';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Rune of Lethargy'].name, dataPowerAlias['Rune of Lethargy'].desc, 2, null, dataPowerAlias['Rune of Lethargy'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
dataRequireGroupPower[dataPower.length-1] = 'sorcery';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Ephemeral Endowment'].name, dataPowerAlias['Ephemeral Endowment'].desc, 2, null, dataPowerAlias['Ephemeral Endowment'].tip));
dataRequireGroupPower[dataPower.length-1] = 'sorcery';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Light Everlasting'].name, dataPowerAlias['Light Everlasting'].desc, 2, null, dataPowerAlias['Light Everlasting'].tip));
dataRequireGroupPower[dataPower.length-1] = 'sorcery';
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Invocation of Storm Calling', '<img src="img/Sorcery_InvocationOfStormCalling.png" />&nbsp;Invocation of Storm Calling', 6, 22, pow++, 2, 'Primal Sorcery, 25 foot Sphere PBAoE Damage and Repel<br /><br />Requires 3 powers from Primal Sorcery or 4 non-energy building powers from any framework.<br /><br />Invocation of Storm Calling calls upon nature\\\'s fury to drive your enemies away from you.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Electrical Storm', 'Electrical Storm', 2, null, 'Your storm now deals periodic damage while it is maintained.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Forced March', 'Forced March', 2, null, 'Forced March increases the duration your Zombies are summoned for.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Runic Glow', 'Runic Glow', 0, null, 'Grants your Aura of Radiant Protection the appearance of magical rune circles floating around you.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Sigils of Radiant Sanctuary', '<img src="img/Sorcery_SigilsOfRadiantSanctuary.png" />&nbsp;Sigils of Radiant Sanctuary', 6, 24, pow++, 1, 'Radiant Sorcery, Sigils AoE Stealth Buff<br /><br />Requires 1 power from Radiant Sorcery or 2 non-energy building powers from any framework.<br /><br />Sigils of Radiant Sanctuary summons 5 sigil stones that effectively hide you and your allies within their circle.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Mystic Transference'].name, dataPowerAlias['Mystic Transference'].desc, 1, null, dataPowerAlias['Mystic Transference'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Divine Renewal', '<img src="img/Sorcery_DivineRenewal.png" />&nbsp;Divine Renewal', 6, 24, pow++, 2, 'Radiant Sorcery, 15 foot Sphere PBAoE Single Friend Revive<br /><br />Requires 3 powers from Radiant Sorcery or 4 non-energy building powers from any framework.<br /><br />Divine Renewal uses eldritch energy to revive your defeated friends.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Radiant Renewal', 'Radiant Renewal', 3, null, 'Radiant Renewal resurrects up to 4 teammates within 25 feet, but the charge time is increased.'));
...
dataRequireGroup['supernatural'] = new Array();
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Rip and Tear', 'Rip and Tear', 2, null, 'Tear and rip! Bestial Fury attacks now have a 15% (30% while Enraged) chance to cause the enemy to begin Bleeding.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Shred', '<img src="img/Supernatural_Shred.png" />&nbsp;Shred', 6, 25, pow++, 0, 'Bestial Supernatural, 10 foot Melee Single Target Damage and Bleed<br /><br />Shred uses your claws to slash at your enemies, frequently causing them to start bleeding.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Penetrating Strikes', 'Penetrating Strikes', 2, null, 'You strike with such power that you have a 50% chance to temporarily weaken the defenses of your foe.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Furor Venenum', 'Furor Venenum', 2, null, '20% (100% on full charge) chance to apply Infection. Biting a Bleeding target causes you to become Enraged or refreshes the duration of Enrage.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Fear Sense', 'Fear Sense', 2, null, 'You can truly smell the fear of your enemies. You capitalize on this, dealing additional damage to Feared targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Paralytic Bile'].name, dataPowerAlias['Paralytic Bile'].desc, 1, null, dataPowerAlias['Paralytic Bile'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['Infectious Bile'].name, dataPowerAlias['Infectious Bile'].desc, 2, null, dataPowerAlias['Infectious Bile'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['Locust Breath'].name, dataPowerAlias['Locust Breath'].desc, 0, null, dataPowerAlias['Locust Breath'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(7, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Furious Rush', 'Furious Rush', 2, null, 'The rage of combat pushes you on, causing you to deal additional damage with Pounce while Enraged.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Glossolalia'].name, dataPowerAlias['Glossolalia'].desc, 2, null, dataPowerAlias['Glossolalia'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataRequireGroupPower[dataPower.length-1] = 'supernatural';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, dataPowerAlias['Evanescent Emergence'].name, dataPowerAlias['Evanescent Emergence'].desc, 2, null, dataPowerAlias['Evanescent Emergence'].tip));
dataRequireGroupPower[dataPower.length-1] = 'supernatural';
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Make them Tremble', 'Make them Tremble', 1, null, 'The enemies who hear your Howl are so terrified they have a difficult time moving, becoming Snared for a short while.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Blood Mess', 'Blood Mess', 2, null, 'Your Massacre deals additional damage to Bleeding targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2EB'].name, dataPowerAlias['R2EB'].desc, 2, null, dataPowerAlias['R2EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Toxin Overload', 'Toxin Overload', 2, null, 'Infernal Bolts has a chance to apply Deadly Poison on each shot instead of just the first.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Infernal Blast', '<img src="img/Supernatural_InfernalBlast.png" />&nbsp;Infernal Blast', 6, 26, pow++, 0, 'Infernal Supernatural, 100 foot Ranged Single Target Damage and Poison<br /><br />Infernal Blast is a highly focused bolt of Toxic power. Your foes will lose this war of attrition.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Virulent Propagation', 'Virulent Propagation', 2, null, 'Fully charging this power on a Poisoned target will spread the affliction to a nearby foe. This can occur for each type of Poison on the target. Refreshes the duration of all Poisons on all targets hit.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Phlebotomist', 'Phlebotomist', 2, null, 'Causes Devour Essence to Root its target for the duration of the attack, and Devour Essence will gain 150% healing from Bleeding or Poisoned targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Kyoketsu Shoge', 'Kyoketsu Shoge', 2, null, 'Adds 1 second charge. Full charge does considerably more damage but does not pull target. All hits cause Bleeding.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Vicious Cyclone', '<img src="img/Supernatural_ViciousCyclone.png" />&nbsp;Vicious Cyclone', 6, 26, pow++, 1, 'Infernal Supernatural, 25 foot Sphere PBAoE Damage and Knock Back<br /><br />Requires 1 power from Infernal Supernatural or 2 non-energy building powers from any framework.<br /><br />Vicious Cyclone swings an infernal chain around you, lashing out at any enemies that come within its path.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Vortex Technique', 'Vortex Technique', 2, null, 'Vicious Cyclone becomes a Knock Towards instead of a Knock Away. Maintaining for at least 2 seconds applies or refreshes Enraged.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Redemption Denied', 'Redemption Denied', 2, null, 'On a full charge, Condemn now Paralyzes your primary target and Stuns any other affected targets.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(6, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Epidemic', '<img src="img/Supernatural_Epidemic.png" />&nbsp;Epidemic', 6, 26, pow++, 2, 'Infernal Supernatural, 25 foot Sphere PBAoE Damage and Poison<br /><br />Requires 3 powers from Infernal Supernatural or 4 non-energy building powers from any framework.<br /><br />Unleash a great plague upon your enemies.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Outbreak', 'Outbreak', 2, null, 'Reduces the maximum maintain time of this power by one second. Also increases the chance to apply Deadly Poison to 25%.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Crippling Coils', '<img src="img/Supernatural_CripplingCoils.png" />&nbsp;Crippling Coils', 6, 26, pow++, 2, 'Infernal Supernatural, 50 foot Ranged Single Target Hold<br /><br />Requires 3 powers from Infernal Supernatural or 4 non-energy building powers from any framework.<br /><br />Crippling Coils sends chains through the ground to latch on to your foe, preventing them from attacking or even moving.');
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Barbed Chains', 'Barbed Chains', 2, null, 'Any time an opponent breaks free from a Hold while affected by Crippling Coils they take a moderate amount of Slashing damage and begin Bleeding.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Festering Bites', 'Festering Bites', 2, null, 'Each time your Locust Swarm deals damage, it has a 15% chance to apply Deadly Poison, which stacks up to 10 times and causes your target to suffer Toxic damage over time.'));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Plague Bearer', 'Plague Bearer', 2, null, 'Fully charging Defile places an AoE Toxic DoT on your target. The target and other foes within 10 feet take Toxic damage over time.'));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantage.push(new PowerAdvantage(3, 'Grave Consequences', 'Grave Consequences', 2, null, 'Summons three Zombies to help your return to the land of the living succeed.'));
...
var dataArchetypeGroup = new Array();
...
// archetype class
/**@constructor*/
Archetype = function(id, name, desc, group, superStat, innateTalent, power, tip) {
    this.id = id;
    this.name = name;
    this.desc = desc;
    ...
    this.toString = function() {
        superStat = '[';
        for (var i=1; i<this.superStat.length; i++) {
            if (i > 1) superStat = superStat+', ';
            superStat = superStat+this.superStat[i]+' ('+dataSuperStat[this.superStat[i]].name+')';
        }
        superStat = superStat+']';
        power = '[';
        for (var i=1; i<this.power.length; i++) {
            if (i > 1) power = power+', ';
            if (this.power[i] instanceof Array) {
                power = power+'[';
                for (j=1; j<this.power[i].length; j++) {
                    if (j > 1) power = power+', ';
                    power = power+this.power[i][j]+' ('+dataPower[this.power[i][j]].name+')';
                }
                power = power+']';
            } else {
                power = power+this.power[i]+' ('+dataPower[this.power[i]].name+')';
            }
        }
        power = power + ']';
        return '[id='+this.id+', name=\''+this.name+'\', desc=\''+this.desc+'\', group='+this.group+' ('+dataArchetypeGroup[this.group].name+') , superStat='+superStat+', innateTalent='+this.innateTalent+' ('+dataInnateTalent[this.innateTalent].name+') , power='+power+', tip=\''+this.tip+'\', code='+this.code()+']';
    }
}

// archetype data
var dataArchetype = new Array();
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, null, null, null, null, null, null, null);
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'Freeform', '<img src="img/Archetype_Freeform.png" />&nbsp;Freeform', 'Freeform', null, null, null, 'Choose this option to mix and match your starting powers from any archetype. Tailor your hero\\\'s characteristics by choosing an Innate Talent. Archetypes are built and balanced to provide everything a hero needs, but those who want complete control can use a custom champion.');
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'The Inferno', '<img src="img/Archetype_Inferno.png" />&nbsp;The Inferno', 'Ranged', new Array('Super Recovery', 'Super Endurance', 'Super Ego'), 'The Inferno', new Array('Throw Fire', 'Fire Strike', 'Fireball', 'Fiery Form', new Array('Fire Breath', 'Pyre'), 'Fire Shield', 'Conflagration', 'Thermal Reverberation', 'Immolation', new Array('Heat Wave', 'Fire Snake'), 'Flashfire'), 'You control the devastating element of fire, creating and shaping it to your will. Whether hurling flaming projectiles or erupting into a deadly firestorm, you leave a blazing swath of destruction in your wake.<br /><br />Concepts: Fire Mutation, Flame Mage, Magma Creature, Plasma Control Suit, Pyrokinetic<br /><br />You have ranged area attacks that cause damage over time. You can\\\'t take a lot of damage though, so be sure to hit your targets hard enough to take them down or recruit a tough ally who can take the damage for you. You can also absorb energy from fire around you, so you become most powerful when you set things on fire. Light things up and feel the burn!');
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'The Tempest', '<img src="img/Archetype_Tempest.png" />&nbsp;The Tempest', 'Ranged', new Array('Super Endurance', 'Super Ego', 'Super Recovery'), 'The Tempest', new Array('Electric Bolt', 'Lightning Arc', 'Sparkstorm', 'Electric Form', 'Thunderstrike', 'Electric Shield', new Array('Electrocute', 'Ball Lightning'), 'Ionic Reverberation', 'Electric Sheath', new Array('Lightning Storm', 'Invocation of Storm Calling'), 'Gigabolt'), 'You are able to control and create electrical currents, generating electricity on your own or even directly affecting the weather itself. With a bolt of lightning from the sky or a continuous barrage of electricity, you are able to devastate your foes.<br /><br />Concepts: Tesla Coil Suit, Air Elemental, Electric Mutation, Lightning Wizard, Weather Control Artifact<br /><br />You have a variety of ranged attacks, many of which are capable of hitting multiple foes. Many of your powers leave your targets electrically charged, setting you up for future attacks against them. You aren\\\'t so great at taking a beating yourself, so take them down quickly before they overwhelm you.');
...
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'The Radiant', '<img src="img/Archetype_Freeform.png" />&nbsp;The Radiant', 'Support', new Array('Super Presence', 'Super Ego', 'Super Intelligence'), 'The Radiant', new Array('Eldritch Bolts', 'Rebuke', 'Vengeance', 'Seraphim', new Array('Sigils of Radiant Sanctuary', 'Ritual of Radiant Summoning'), 'Eldritch Shield', new Array('Expulse', 'Pillar of Poz'), 'Arcane Vitality', new Array('Binding of Aratron', 'Soul Mesmerism'), 'Circle of Radiant Glory', 'Planar Fracture'), 'You have unlocked mysterious arcane secrets. You use this knowledge to weave powerful magic into auras, sigils, and spells designed to confound your enemies and protect your allies.<br /><br />Concepts: Dimensional Sorcerer, Master Mage, Rune Witch, Shaman, Street Wizard<br /><br />You have a good range of abilities that allow you to set up areas of control to focus your mystic powers. This allows you to heal your allies, debilitate your foes, and deal decent area effect damage.');
...
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'The Inventor', '<img src="img/Archetype_Inventor.png" />&nbsp;The Inventor', 'Support', new Array('Super Intelligence', 'Super Presence', 'Super Ego'), 'The Inventor', new Array('Sonic Blaster', 'Experimental Blaster', 'Experimental Burst Ray', 'Medical Nanites', new Array('Attack Toys', 'Munitions Bots'), 'Energy Shield', 'Bionic Shielding', 'Support Drones', 'Miniaturization Drive', new Array('Sonic Device', 'Toxic Nanites'), 'Orbital Cannon'), 'You are an incredibly gifted creator of advanced technology, using unconventional ideas that the average person would think impossible. Your quirky designs get the job done, with only the occasional unintended side effect.<br /><br />Concepts: Scientific Entrepreneur, Prototype Cyber Soldier, Technopath, Kid Genius, Mad Scientist<br /><br />Your set of wacky gadgets provides you with a good variety of abilities. You will learn to create personal robots to aid you in combat, and several of your gizmos will be valuable assets in assisting other heroes.');
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'The Cursed', '<img src="img/Archetype_Cursed.png" />&nbsp;The Cursed', 'Ranged', new Array('Super Recovery', 'Super Constitution', 'Super Ego'), 'The Scourge', new Array('Infernal Bolts', 'Infernal Blast', 'Condemn', 'Pestilence', new Array('Venomous Breath', 'Vicious Cyclone'), 'Ebon Void', new Array('Locust Swarm', 'Crippling Coils'), 'Supernatural Power', 'Aspect of the Infernal', 'Epidemic', 'Defile'), 'Your power comes from somewhere beyond this mortal realm, allowing you to infest your foes with toxic energy. You use these infernal powers as you see fit, leaving your foes gasping through an onslaught of poison.<br /><br />Concepts: Toxic Mutant, Demonic Gift, Ancient Curse, Nightmare Creature, Remorseful Demon<br /><br />Many of your powers poison your foes, and your strength increases as your poisons wither them away. Your pestilent clouds will weaken your foes as you press the attack, and you\\\'ll have some ability to hinder your opponents\\\' mobility.');
